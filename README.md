...
```javascript
dnancount = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnancount@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dnancount/tags). For example,

```javascript
dnancount = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnancount@v0.0.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnancount = require( 'path/to/vendor/umd/blas-ext-base-dnancount/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnancount@umd/browser.js"></script>
```
